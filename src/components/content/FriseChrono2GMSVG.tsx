...
export const FriseChrono2GMSVG: React.FC = () => {
  const events = [
    { year: '1939', title: 'Invasion Pologne', desc: 'Début de la guerre (1er sept.)', color: 'bg-red-500' },
    { year: '1940', title: 'Appel du 18 juin', desc: 'De Gaulle & la Résistance', color: 'bg-blue-500' },
    { year: '1942', title: 'Stalingrad', desc: 'Tournant du conflit', color: 'bg-orange-500' },
    { year: '1944', title: 'Débarquement', desc: 'Libération de la France', color: 'bg-green-500' },
    { year: '1945', title: 'Capitulations', desc: 'Fin de la guerre (8 mai/2 sept.)', color: 'bg-green-600' }
  ];

  return (
    <div className="w-full bg-surface p-6 rounded-2xl border border-border shadow-lg my-8 overflow-hidden">
      <div className="text-lg font-bold mb-8 text-center text-white">Repères : La Seconde Guerre mondiale</div>
